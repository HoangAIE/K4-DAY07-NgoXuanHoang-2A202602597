...
class EmbeddingStore:
    ...
    def __init__(
        ...
        try:
            ...
            # Khởi tạo ChromaDB client (in-memory) + collection
    ...
    def _make_record(self, doc: Document) -> dict[str, Any]:
        """Tạo một bản ghi lưu trữ chuẩn hóa cho một document."""
    ...
    def _search_records(self, query: str, records: list[dict[str, Any]], top_k: int) -> list[dict[str, Any]]:
        """Chạy tìm kiếm độ tương tự in-memory trên danh sách records cho trước."""
        if not records:
            return []
    ...
    def add_documents(self, docs: list[Document]) -> None:
        ...
        if self._use_chroma and self._collection is not None:
            ...
            for doc in docs:
                ...
                record["metadata"] = {"doc_id": doc.id, **doc.metadata}
    ...
    def search_with_filter(self, query: str, top_k: int = 3, metadata_filter: dict = None) -> list[dict]:
        ...
        if self._use_chroma and self._collection is not None:
            ...
            if n_results == 0:
                return []
            # Chuyển metadata_filter thành ChromaDB where format
        ...
        # In-memory: lọc trước rồi tìm kiếm
        filtered_records = []
